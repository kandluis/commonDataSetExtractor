...
def main():
  ...
  OUTPUT_COLUMNS = [
      column for column in (
          ...
          'ED Admissions Rate', 'Number of ED Applicants',
          'Number of ED Applicants Admitted', 'EA Deadline', 'EA Notification',
          'ED I Deadline', 'ED I Notification', 'ED II Deadline',
          'ED II Notification', 'Average GPA', 'SAT Math 25%', 'SAT Math 75%',
          'SAT Reading 25%', 'SAT Reading 75%', 'GPA >3.75', 'GPA >3.50',
          'GPA >3.25', 'GPA >3.00', 'GPA >2.50', 'GPA >2.00', 'GPA >1.00 ',
